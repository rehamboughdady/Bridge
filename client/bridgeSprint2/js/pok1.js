...
// if(start == "north")
// {
// var player1 = PlayedCardsArr[0];         //north        player1.card
// var player2 = PlayedCardsArr[1];         //east         player2.card
// var player3 = PlayedCardsArr[2];         //south        player3.card
// var player4 = PlayedCardsArr[3];
// }

// else if(start == "east")
// {
// var player2 = PlayedCardsArr[0];         //north        player1.card
// var player3 = PlayedCardsArr[1];         //east         player2.card
// var player4 = PlayedCardsArr[2];         //south        player3.card
// var player1 = PlayedCardsArr[3];
// }

// else if(start == "south")
// {
// var player3 = PlayedCardsArr[0];         //north        player1.card
// var player4 = PlayedCardsArr[1];         //east         player2.card
// var player1 = PlayedCardsArr[2];         //south        player3.card
// var player2 = PlayedCardsArr[3];
// }

// else if(start == "west")
// {
// var player4 = PlayedCardsArr[0];         //north        player1.card
// var player1 = PlayedCardsArr[1];         //east         player2.card
// var player2 = PlayedCardsArr[2];         //south        player3.card
// var player3 = PlayedCardsArr[3];
// }
...
//     socket.emit('trickscore',trickscore);
...
// console.log("i am "+StartTrickPlayer);
// }

 
// //commented 14/10/2019 br reham
// function trick() {
...
//     console.log("decscore "+declarerscore+" defscore "+defenderscore);
    
//     var  scorearray=[];
// if((declarerscore + defenderscore) ==  13)
// {
// scorearray=[declarerscore,defenderscore];
